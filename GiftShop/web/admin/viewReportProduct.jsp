...
<html>
    <head>
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-edit"></i>List Product </h1>
                    <p>List products</p>
                </div>
        ...
        <div class="wrapper">
            ...
            <section class="content d-none d-print-block">
                ...
                <div class="row invoice-info d-none d-print-block">
                    ...
                    <!-- /.col -->
                    <div class="col-sm-4 invoice-col">
                        &nbsp;   <b> Report Product from ${dateStart} to ${dateEndd}</b>

                        <address>
                            <strong>&nbsp; &nbsp; Product name : ${pro.proName}</strong><br>
            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="table-responsive">
                        <table class="table">
                            <tr>
                            <h3 style="color: #00635a"><b> &nbsp; &nbsp;  The total of order have status completed :</b> <span>$<fmt:formatNumber value="${totalProfit}" maxFractionDigits="0"/></span></h3>
                            </tr>
                        </table>
                    </div>
                </div><!-- /.col -->
