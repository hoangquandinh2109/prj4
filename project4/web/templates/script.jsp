<%-- 
    Document   : script
    Created on : Apr 15, 2019, 11:03:08 AM
    Author     : johnn
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<script src="${pageContext.request.contextPath}/assets/library/jquery/js/jquery.min.js"></script>
<script src="${pageContext.request.contextPath}/assets/library/bootstrap/js/bootstrap.3.4.0.min.js"></script>
<script src="${pageContext.request.contextPath}/assets/library/owlcarousel/js/owl.carousel.min.js"></script>
<script src="${pageContext.request.contextPath}/assets/js/slideconfig.js"></script>
