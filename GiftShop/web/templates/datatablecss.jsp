<%-- 
    Document   : datatablecss
    Created on : May 14, 2019, 5:05:49 PM
    Author     : Hung
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/library/bootstrap/css/dataTables.bootstrap4.min.css"/>
