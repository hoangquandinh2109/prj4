                        ...
                        <div class="row">
                            ...
                            <div class="right-column">
                                ...
                                <c:forEach items="${list}" var="sd">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="product-item">
                                            <div class="image-product">
                                                <a href=""><img class="m0-auto" src="https://cdn.shopify.com/s/files/1/2334/1307/products/Untitled-4_f4c92dfe-1709-4406-bec4-21c707ea1b38_160x140.png" alt=""></a>
                                            </div>
                                    ...
                                    <c:if test="${i == 4}">
                                    </div><c:set var="i" value="0" />
                                    </c:if>
                                </c:forEach>
                                </div>
                                <div class="event">
                                    <a href=""><img src="https://cdn.shopify.com/s/files/1/2334/1307/files/home_bannercenter_873x160.png?v=1507088526" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
