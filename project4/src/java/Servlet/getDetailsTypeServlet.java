 ...
 * @author Asus
 */
public class getDetailsTypeServlet extends HttpServlet {
...
//            productTypeFacade.edit(types);
            int code = Integer.parseInt(request.getParameter("typeID"));
            ProductType types = productTypeFacade.find(code);
